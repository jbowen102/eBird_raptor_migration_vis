		...
		<main id="main" class="site-main" role="main">
			...
			<div class="entry-content special-page-content">
                ...
                <div id="viz-wrapper">
                    ...
                    <div id="year-range-controls">
                        <div class="control-wrap year-slider-wrap" id="year-start-slider-wrap">
                            <label for="year-start-slider">Start year: <span id="year-start-label">All years</span></label>
                            <input id="year-start-slider" type="range" min="0" max="1" value="0" disabled>
                        </div>
                        <div class="control-wrap year-slider-wrap" id="year-end-slider-wrap">
                            <label for="year-end-slider">End year: <span id="year-end-label">All years</span></label>
                            <input id="year-end-slider" type="range" min="0" max="1" value="1" disabled>
                        </div>
                        <div id="year-range-status">All years (dataset is pre-aggregated)</div>
                    </div>
